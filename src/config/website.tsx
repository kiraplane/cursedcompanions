...
export const websiteConfig: WebsiteConfig = {
  ...
  metadata: {
    images: {
      ogImage: '/cursedcompanions/og-image.png',
      logoLight: '/android-chrome-192x192.png',
      logoDark: '/android-chrome-192x192.png',
    },
    social: {
      github: 'https://github.com/kiraplane/cursedcompanions',
      twitter: 'https://x.com/CursedCompani0n',
      blueSky: 'https://bsky.app/profile/cursedcompanions.bsky.social',
      discord: 'https://discord.gg/cursedcompanions',
      mastodon: '',
      linkedin: '',
      youtube: 'https://www.youtube.com/watch?v=K5XnfqoBXfU',
      instagram: 'https://www.instagram.com/cursedcompanionsgame/',
      tiktok: 'https://www.tiktok.com/@cursed.companions',
    },
  },
  features: {
  ...
  mail: {
    provider: 'resend',
    fromEmail: 'Cursed Companions Wiki <hello@cursedcompanions.wiki>',
