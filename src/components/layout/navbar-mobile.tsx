        ...
        <div className="flex items-center justify-end gap-4">
          <Button
            ...
            className="size-8 flex aspect-square h-fit cursor-pointer select-none items-center
              justify-center rounded-md border border-[#28484A] text-[#F7F2DF] hover:border-[#D989FF] hover:bg-[#0C2222]"
          >
            {open ? (
...
function MainMobileMenu({ onLinkClicked }: MainMobileMenuProps) {
  ...
  return (
    <div
      ...
      border-[#28484A] border-t bg-[#061313] text-[#F7F2DF] backdrop-blur-md animate-in fade-in-0"
    >
      <div className="size-full flex flex-col items-start space-y-4 pt-4">
                ...
                {item.items ? (
                    ...
                    <CollapsibleTrigger asChild>
                      <Button
                        ...
                        className={cn(
                          ...
                          'bg-transparent text-[#AFC8C0] cursor-pointer',
                          'hover:bg-transparent hover:text-[#7CFF6B]',
                          'focus:bg-transparent focus:text-[#7CFF6B]',
                          isActive &&
                            'font-semibold bg-transparent text-[#7CFF6B]'
                        )}
                      >
                            ...
                            <li key={subItem.title}>
                              ...
                              >
                                ...
                                {subItem.external && (
                                  <ArrowUpRightIcon
                                    className={cn(
                                      'size-4 shrink-0 text-[#AFC8C0] items-center',
                                      'group-hover:bg-transparent group-hover:text-[#7CFF6B]',
                                      'group-focus:bg-transparent group-focus:text-[#7CFF6B]',
                                      isSubItemActive &&
                                        'bg-transparent text-[#7CFF6B]'
                  ...
                  <LocaleLink
                    ...
                    className={cn(
                      ...
                      'hover:bg-transparent hover:text-[#7CFF6B]',
                      'focus:bg-transparent focus:text-[#7CFF6B]',
                      isActive && 'font-semibold bg-transparent text-[#7CFF6B]'
                    )}
                    onClick={onLinkClicked}
                  >
        ...
        {/* bottom buttons */}
        <div className="flex w-full items-center justify-center gap-4 border-[#28484A]/70 border-t p-4">
          <LocaleSelector />
        </div>
      </div>
    </div>
