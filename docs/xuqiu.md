...
cursed companions这个游戏的攻略站。所以我希望满足用户的攻略相关的需求。网站的名称就叫
cursed companions
本项目网站的网址域名为：www.cursedcompanions.wiki
网站的关键词要有cursed companions、cursed companions wiki等
将原文件夹内容做改造，没用的内容剔除，只服务cursedcompanions
...
3.官方商店是：https://store.steampowered.com/app/3265230/Cursed_Companions/
...
6.开发完成后在github上创建仓库cursedcompanions，将本项目上传
7.在cloudflare上面的worker创建项目cursedcompanions部署并关联域名，域名我已经加好
